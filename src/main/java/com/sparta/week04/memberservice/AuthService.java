...
public class AuthService {
    ...
    public AuthService(AuthenticationManagerBuilder authenticationManagerBuilder, MemberRepository memberRepository, PasswordEncoder passwordEncoder, TokenProvider tokenProvider, RefreshTokenRepository refreshTokenRepository) {
    ...
    public MemberResponseDto<?> signup(SignupRequestDto signupRequestDto) {
        if (memberRepository.existsByName(signupRequestDto.getUserNickname())) {
